 ...
 * Card thumbnail uses 1.jpg; clicking a card opens a lightbox of all photos.
 */
...
export const fleet: FleetVehicle[] = [
  { slug: "fiat-punto-grande",   name: "Fiat Punto Grande",         categories: ["compact"],           transmission: "automatic", seats: 5, priceFrom: 24.99,  imageCount: 0 },
  ...
  { slug: "polo",                name: "VW Polo",                   categories: ["compact"],           transmission: "automatic", seats: 5, priceFrom: 34.99,  imageCount: 8 },
  { slug: "golf-6",              name: "VW Golf 6",                 categories: ["compact"],           transmission: "automatic", seats: 5, priceFrom: 39.99,  imageCount: 8 },
  { slug: "bmw-1",               name: "BMW serija 1",              categories: ["compact"],           transmission: "automatic", seats: 5, priceFrom: 49.99,  imageCount: 0 },
  ...
  { slug: "passat-7",            name: "VW Passat 7",               categories: ["sedan"],             transmission: "automatic", seats: 5, priceFrom: 49.99,  imageCount: 8 },
  ...
  { slug: "bmw-x6",              name: "BMW X6",                    categories: ["suv", "luxury"],     transmission: "automatic", seats: 5, priceFrom: 79.99,  imageCount: 8 },
